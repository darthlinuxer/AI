# INTEGRATION TESTS FOR LOCAL CHROMADB WITH LANGCHAIN LIBRARY

import unittest
from Repository.ChromaRepository import ChromaRepository
...
from Repository.CustomRetrievers import (
...
class TestChromaRepository(unittest.TestCase):
    def setUp(self):
        self.chroma_repo = ChromaRepository(
            persist_directory="Basic_Tutorials/Databases",
    ...
    def test_04_context_search_with_smallchunkretriever_strategy_with_vectorrepository(self):
        documents = [
            Document(
                page_content="""
                I have a dog. Her name is Pity
